...
const Anecdotes = (props) => {
  return(
    <div>
      ...
      <div>tiene {props.votes} votos</div>
    </div>
  )
}
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Button handleClick={nextClick} text='próxima anecdota'/>
      <Button handleClick={voteClick} text='votar'/>
      <Title text='Anécdota con más votos'/>
